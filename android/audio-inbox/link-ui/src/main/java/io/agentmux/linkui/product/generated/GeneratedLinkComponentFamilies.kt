...
enum class GeneratedLinkComponentTypeId(val wireId: String) { LINK_TARGET_PICKER("link.target-picker"), LINK_TALK("link.talk"), LINK_LATEST_TURN("link.latest-turn"), LINK_COMPOSER("link.composer"), LINK_ACTIVE_PLAYBACK("link.active-playback"), LINK_CONNECTION_STATUS("link.connection-status"), LINK_PUBLIC_LINK("link.public-link"), LINK_PREFERENCES("link.preferences"), LINK_LOCAL_HISTORY("link.local-history"), LINK_UPDATES("link.updates"), LINK_RECOVERY_STATUS("link.recovery-status"), LINK_PAGE_HOST("link.page-host"), LINK_NAVIGATION_ENTRY("link.navigation-entry"), LINK_DEV_HOST_ENTRY("link.dev-host-entry"), LINK_DEV_PREVIEW("link.dev-preview"), LINK_WAKE_DEBUG_ENTRY("link.wake-debug-entry"), LINK_WAKE_DEBUG("link.wake-debug"), LINK_WAKE_TRY_ENTRY("link.wake-try-entry"), LINK_WAKE_TRY("link.wake-try"), LINK_WAKE_WORD("link.wake-word"), LINK_WAKE_TOGGLE("link.wake-toggle") }
enum class GeneratedLinkComponentId(val wireId: String, val type: GeneratedLinkComponentTypeId) {
    NAVIGATION_PAGE_HOST("navigation.page-host", GeneratedLinkComponentTypeId.LINK_PAGE_HOST), TARGET_PICKER("target.picker", GeneratedLinkComponentTypeId.LINK_TARGET_PICKER), CAPTURE_TALK("capture.talk", GeneratedLinkComponentTypeId.LINK_TALK), CONVERSATION_LATEST("conversation.latest", GeneratedLinkComponentTypeId.LINK_LATEST_TURN), CONVERSATION_COMPOSER("conversation.composer", GeneratedLinkComponentTypeId.LINK_COMPOSER), PLAYBACK_CONTROLS("playback.controls", GeneratedLinkComponentTypeId.LINK_ACTIVE_PLAYBACK), SESSION_CONNECTION("session.connection", GeneratedLinkComponentTypeId.LINK_CONNECTION_STATUS), SESSION_PUBLIC_LINK("session.public-link", GeneratedLinkComponentTypeId.LINK_PUBLIC_LINK), PREFERENCES_TOGGLES("preferences.toggles", GeneratedLinkComponentTypeId.LINK_PREFERENCES), HISTORY_LOCAL("history.local", GeneratedLinkComponentTypeId.LINK_LOCAL_HISTORY), UPDATES_PANEL("updates.panel", GeneratedLinkComponentTypeId.LINK_UPDATES), RECOVERY_STATUS("recovery.status", GeneratedLinkComponentTypeId.LINK_RECOVERY_STATUS), NAVIGATION_SETTINGS_ENTRY("navigation.settings-entry", GeneratedLinkComponentTypeId.LINK_NAVIGATION_ENTRY), NAVIGATION_DEV_HOST_ENTRY("navigation.dev-host-entry", GeneratedLinkComponentTypeId.LINK_DEV_HOST_ENTRY), DEV_PREVIEW("dev.preview", GeneratedLinkComponentTypeId.LINK_DEV_PREVIEW), NAVIGATION_WAKE_DEBUG_ENTRY("navigation.wake-debug-entry", GeneratedLinkComponentTypeId.LINK_WAKE_DEBUG_ENTRY), WAKE_DEBUG("wake.debug", GeneratedLinkComponentTypeId.LINK_WAKE_DEBUG), NAVIGATION_WAKE_TRY_ENTRY("navigation.wake-try-entry", GeneratedLinkComponentTypeId.LINK_WAKE_TRY_ENTRY), WAKE_TRY("wake.try", GeneratedLinkComponentTypeId.LINK_WAKE_TRY), WAKE_TOGGLE("wake.toggle", GeneratedLinkComponentTypeId.LINK_WAKE_TOGGLE), WAKE_STATUS("wake.status", GeneratedLinkComponentTypeId.LINK_WAKE_WORD)
}
...
object GeneratedLinkComponentFamilies {
    val bindings: Set<GeneratedLinkComponentFamilyBinding> = setOf(
        ...
        GeneratedLinkComponentFamilyBinding(
            ...
            components = setOf(GeneratedLinkComponentId.NAVIGATION_PAGE_HOST, GeneratedLinkComponentId.SESSION_CONNECTION, GeneratedLinkComponentId.UPDATES_PANEL, GeneratedLinkComponentId.NAVIGATION_DEV_HOST_ENTRY, GeneratedLinkComponentId.RECOVERY_STATUS, GeneratedLinkComponentId.PLAYBACK_CONTROLS, GeneratedLinkComponentId.SESSION_PUBLIC_LINK, GeneratedLinkComponentId.PREFERENCES_TOGGLES, GeneratedLinkComponentId.WAKE_STATUS, GeneratedLinkComponentId.NAVIGATION_WAKE_TRY_ENTRY, GeneratedLinkComponentId.NAVIGATION_WAKE_DEBUG_ENTRY, GeneratedLinkComponentId.HISTORY_LOCAL),
        ),
        GeneratedLinkComponentFamilyBinding(
        ...
        GeneratedLinkComponentFamilyBinding(
            route = GeneratedLinkPageId.WAKE_DEBUG,
            family = GeneratedLinkComponentFamilyRef.LINK_WAKE_DEBUG,
            components = setOf(GeneratedLinkComponentId.NAVIGATION_PAGE_HOST, GeneratedLinkComponentId.WAKE_DEBUG),
        ),
        GeneratedLinkComponentFamilyBinding(
            route = GeneratedLinkPageId.WAKE_TRY,
            family = GeneratedLinkComponentFamilyRef.LINK_WAKE_TRY,
            components = setOf(GeneratedLinkComponentId.NAVIGATION_PAGE_HOST, GeneratedLinkComponentId.WAKE_TRY),
        )
    )

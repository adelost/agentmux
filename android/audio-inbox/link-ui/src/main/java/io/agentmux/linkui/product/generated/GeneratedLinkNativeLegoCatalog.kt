...
internal object GeneratedLinkNativeLegoCatalog {
    object PortIds {
        ...
        data object PREFERENCES_SERVICE_WAKETOGGLE : GeneratedProductInputPortId { override val value = "preferences.service.wakeToggle" }
    ...
    object FiniteValueIds {
        ...
        data object LINK_WAKE_GLYPH : GeneratedLinkFiniteValueId { override val value = "link.wake-glyph" }
    ...
    val finiteValues: List<GeneratedLinkFiniteValueDeclaration> = listOf(
        ...
        GeneratedLinkFiniteValueDeclaration(FiniteValueIds.LINK_PREFERENCE_KEY, setOf("hands-free", "speak-replies", "wake-word", "listening-cue-sound")),
